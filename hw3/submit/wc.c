...
*
*	This program counts the number of words in each text file provided as
*	a command line argument. It creates a new pthread for each text file 
*	and when it rejoins the main process, reports the number of
*	words in the file, and sums it to a running total of all files.
*
*	Users must submit as least one text file, and if there are errors making
